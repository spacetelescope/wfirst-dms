...
PACKAGENAME = metadata.get('package_name', 'wfirstdms')
DESCRIPTION = metadata.get('description', 'Data management system for WFIRST at STScI')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: wfirstdms requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
